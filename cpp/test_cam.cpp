...
{
    Camera.set(CAP_PROP_FRAME_WIDTH, ( "-w", argc, argv, 720 ));
    Camera.set(CAP_PROP_FRAME_HEIGHT, ( "-h", argc, argv, 405 ));
...
void Perspective()
{
    ...
    warpPerspective(frame, framePers, Matrix, Size(720, 405));
...
void Threshold()
{
    ...
    inRange(frameGray, 20, 100, frameThresh);
    Canny(frameGray, frameEdge, 15, 100, 3, false);
}
